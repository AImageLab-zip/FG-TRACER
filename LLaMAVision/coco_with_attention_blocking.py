...
class COCODataset(Dataset):
    def __init__(self, image_dir = '/path/to/coco/val2014', data_path = "LLaMAVision/tracing_information_flow/dataset/coco/coco_dataset_correct_answers.json") -> None:
        super().__init__() 
...
def parse_args():
    parser = argparse.ArgumentParser(description="COCO Information Flow Eval")
    parser.add_argument(
        "--answer_path", type=str, default="LLaMAVision/results/coco"
    )
    parser.add_argument(
    ...
    parser.add_argument("--image_dir", type=str, default="/path/to/coco/val2014", help="Directory of images")
    parser.add_argument("--data_path", type=str, default="LLaMAVision/tracing_information_flow/dataset/coco/coco_dataset_correct_answers.json")
