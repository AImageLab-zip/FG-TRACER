...
class TextVQADataset(Dataset):
    def __init__(self, image_dir = '/path/to/TextVQA/train_val_images/train_images', data_path="LLaMAVision/tracing_information_flow/dataset/textvqa/textvqa_dataset_wrong_answers.json") -> None:
        super().__init__() 
...
def parse_args():
    ...
    parser.add_argument(
        "--answer_path", type=str, default="LLaMAVision/results/textvqa"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--block_types", nargs='+', type=str, default=['full_attention', 'question_to_last', 'image_to_last', 'image_to_question', 'last_to_last', 'layers_pred'], choices=['last_to_last', 'image_to_last', 'question_to_last', 'image_to_question', 'full_attention', 'layers_pred'], help="Blocking types to use"
    )
    parser.add_argument(
    ...
    parser.add_argument("--data_path", type=str, default="LLaMAVision/tracing_information_flow/dataset/textvqa/textvqa_dataset_correct_answers.json", help="Path to TextVQA dataset")
