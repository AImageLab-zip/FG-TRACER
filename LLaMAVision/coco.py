...
class COCODataset(Dataset):
    def __init__(self, image_dir = '/path/to/coco/val2014', data_path = "/path/to/coco/annotations/captions_val2014.json") -> None:
        super().__init__() 
...
def parse_args():
    ...
    parser.add_argument(
        "--answer_path", type=str, default="LLaMAVision/results/coco.json"
    )
    parser.add_argument(
    ...
    parser.add_argument("--data_path", type=str, default="/path/to/coco/annotations/captions_val2014.json", help="Path to COCO annotations")
