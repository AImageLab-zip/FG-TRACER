...
class Llama3_Vision(nn.Module):
    ...
    def generate(
        ...
        output = self.llama_model.generate(**tokens, max_new_tokens=max_gen_tokens, do_sample=False) 
            ...
            for block_type in block_types:
                ...
                if block_type in ['last_to_last', 'image_to_last', 'question_to_last', 'image_to_question', 'full_attention', 'layers_pred']:
                    ...
                    for i in range(answer_tokens.shape[2]):
                        ...
                        if a_token == self.llama_processor.tokenizer.eos_token_id : #128009 = <|eot_id|>
                            continue
                        ...
                        if block_type in ['last_to_last', 'image_to_last', 'question_to_last', 'image_to_question', 'layers_pred']:
                            ...
                            word = self.llama_processor.tokenizer.decode([a_token])
