...
with open("LLaVA/tracing_information_flow/datasets/textvqa/correct_answers_textvqa.json", "r") as f:
    results = json.load(f)
...
for result in results:  # 3926 results -> 2680 samples in filtered_classes
    ...
    for img_class in sample['image_classes']:
        if img_class in filter_classes:
            ...
            break
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
with open("LLaVA/tracing_information_flow/datasets/textvqa/textvqa_dataset_correct_answers.json", "w") as f:
...
# %% 
with open("LLaVA/tracing_information_flow/datasets/textvqa/ids_textvqa_wrong.json", "w") as f:
