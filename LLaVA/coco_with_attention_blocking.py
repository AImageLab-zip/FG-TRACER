...
class COCODataset(Dataset):
    def __init__(self, image_dir = '/path/to/datasets/coco/val2014', data_path = "LLaVA/tracing_information_flow/datasets/coco/coco_dataset_correct_answers_common.json") -> None:
        super().__init__() 
...
def parse_args():
    ...
    parser.add_argument(
        "--answer_path", type=str, default="LLaVA/results/coco"
    )
    parser.add_argument(
    ...
    parser.add_argument("--data_path", type=str, default="LLaVA/tracing_information_flow/datasets/coco/coco_dataset_correct_answers_common.json")
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        for data in tqdm(dataloader):
            ...
            prob_layers = model.generate_multimodal_with_attention_blocking(prompt=message, answer_tokens=answer_tokens, image=image, max_gen_len=512, block_types=args.block_types, k=args.k)
