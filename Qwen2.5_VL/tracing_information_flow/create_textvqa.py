...
with open("Qwen2.5_VL/tracing_information_flow/datasets/textvqa/correct_answers_textvqa.json", "r") as f:
    results = json.load(f)
...
for result in results:  # 3926 results -> 2680 samples in filtered_classes
    ...
    for img_class in sample['image_classes']:
        if img_class in filter_classes:
            ...
            break
print(len(new_results)) #2762 samples
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
with open("Qwen2.5_VL/tracing_information_flow/datasets/textvqa/textvqa_dataset_correct_answers.json", "w") as f:
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
with open("Qwen2.5_VL/tracing_information_flow/datasets/textvqa/ids_correct_textvqa.json", "w") as f:
